...
Welcome to `streamlit-demo` contributor's guide.
...
If you experience bugs or general issues with `streamlit-demo`, please have a look
...
You can help improve `streamlit-demo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`streamlit-demo` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `streamlit-demo`'s files. While this mechanism can
...
```
conda create -n streamlit-demo python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/streamlit-demo.git
   cd streamlit-demo
   ```
...
5. Install [pre-commit]:
   ...
   `streamlit-demo` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/streamlit-demo
[issue tracker]: https://github.com/<USERNAME>/streamlit-demo/issues
